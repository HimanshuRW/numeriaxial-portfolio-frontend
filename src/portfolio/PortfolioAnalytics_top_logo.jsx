              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex-shrink-0">
                  <img 
                    src="/logo.png" 
                    alt="Company Logo" 
                    // className="w-12 border bg-white shadow-sm hover:shadow-md transition-all duration-200" 
                    className="w-12 bg-white shadow-sm hover:shadow-md transition-all duration-200" 
                  />
                </div>
              </div>
            </div>
