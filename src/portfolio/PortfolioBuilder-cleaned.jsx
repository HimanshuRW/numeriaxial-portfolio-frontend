...
const PortfolioBuilder = ({ onNavigate }) => {
  ...
  const preBuiltPortfolios = [
    ...
    { 
      id: 3, 
      name: 'Crypto Related', 
      description: 'Companies exposed to crypto',
      icon: Coins,
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="flex justify-between items-center mt-8 pt-8 border-t border-gray-200 dark:border-gray-700">
          ...
          {currentStep < steps.length - 1 && (
            <div className="flex items-center space-x-4">
              {currentStep === 0 && (
                <label className="inline-flex items-center space-x-2 px-6 py-3 bg-gray-600 text-white rounded-lg hover:bg-gray-700 cursor-pointer transition-colors">
