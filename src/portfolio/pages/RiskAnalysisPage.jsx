  ...
  return (
    <div className="space-y-8">
        ...
        <div className={`rounded-xl shadow-lg p-6 transition-colors duration-300 ${
          ...
          <div className="space-y-4">
            {portfolioData.riskMetrics.map((metric, index) => (
              <div key={index} className={`flex items-center justify-between p-4 border rounded-lg transition-colors duration-300 ${
                isDark 
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className={`font-medium ${
                    stock.beta > 1 ? 'text-red-600' : stock.beta < 0.8 ? 'text-green-600' : (isDark ? 'text-white' : 'text-gray-900')
                  }`}>
                    {stock.beta}
                  </span>
                </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className={`text-center p-4 rounded-lg transition-colors duration-300 ${
            ...
            <div className={`text-2xl font-bold mb-2 transition-colors duration-300 ${
              isDark ? 'text-white' : 'text-gray-900'
            }`}>{portfolioData.statistics.volatility}%</div>
            <div className={`text-sm transition-colors duration-300 ${
              isDark ? 'text-gray-400' : 'text-gray-600'
            }`}>Portfolio Volatility</div>
          ...
          <div className={`text-center p-4 rounded-lg transition-colors duration-300 ${
            ...
            <div className={`text-2xl font-bold mb-2 transition-colors duration-300 ${
              isDark ? 'text-white' : 'text-gray-900'
            }`}>{portfolioData.statistics.beta}</div>
            <div className={`text-sm transition-colors duration-300 ${
              isDark ? 'text-gray-400' : 'text-gray-600'
            }`}>Portfolio Beta</div>
            <div className={`mt-2 px-2 py-1 rounded-full text-xs font-medium inline-block ${
          ...
          <div className={`text-center p-4 rounded-lg transition-colors duration-300 ${
            ...
            <div className={`text-2xl font-bold mb-2 transition-colors duration-300 ${
              isDark ? 'text-white' : 'text-gray-900'
            }`}>{portfolioData.statistics.maxDrawdown}%</div>
            <div className={`text-sm transition-colors duration-300 ${
              isDark ? 'text-gray-400' : 'text-gray-600'
            }`}>Max Drawdown</div>
            <div className={`mt-2 px-2 py-1 rounded-full text-xs font-medium inline-block ${
          ...
          <div className={`text-center p-4 rounded-lg transition-colors duration-300 ${
            ...
            <div className={`text-2xl font-bold mb-2 transition-colors duration-300 ${
              isDark ? 'text-white' : 'text-gray-900'
            }`}>{portfolioData.statistics.sharpeRatio}</div>
            <div className={`text-sm transition-colors duration-300 ${
              isDark ? 'text-gray-400' : 'text-gray-600'
            }`}>Sharpe Ratio</div>
            <div className={`mt-2 px-2 py-1 rounded-full text-xs font-medium inline-block ${
      ...
      <div className={`rounded-xl shadow-lg p-6 transition-colors duration-300 ${
        ...
        <h3 className={`text-lg font-semibold mb-6 transition-colors duration-300 ${
          isDark ? 'text-white' : 'text-gray-900'
        }`}>Risk Management Recommendations</h3>
        <div className="grid md:grid-cols-2 gap-6">
          <div className="space-y-4">
            <h4 className={`font-medium transition-colors duration-300 ${
              isDark ? 'text-gray-200' : 'text-gray-800'
            }`}>Portfolio Strengths</h4>
